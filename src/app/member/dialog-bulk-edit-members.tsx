...
interface Props {
    ...
    onSuccess: () => void
    setLoadingEditBulk: (value: boolean) => void // ⬅️ baru
}
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="font-mono sm:max-w-[425px]">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <DialogHeader>
                        <DialogTitle>Edit Massal Member</DialogTitle>
                        <DialogDescription>
                            Update beberapa member sekaligus.
                        </DialogDescription>
                    </DialogHeader>

                    <div className="grid gap-4">
                        <div className="bg-secondary/40 border-border grid gap-2 rounded-sm border p-4 text-sm">
                            <p>Daftar member:</p>
                            <p className="text-sm">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-3">
                                ...
                                <Input
                                    ...
                                    value={lvl}
                                    onChange={(e) =>
                                        setLvl(Number(e.target.value) || 0)
                                    }
                                    required
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-3">
                                <Label htmlFor="trop">Trops</Label>
                                <Input
                                    id="trop"
                                    name="trop"
                                    value={trop}
